    ...
    <div class="box-container">
        <?php if (!empty($categories)) : ?> 
            <?php foreach ($categories as $category) : ?>
                <?php $imgSrc = !empty($category->img) ? $category->img : 'iconlogo.png';?>
                <div class="box">
                    ...
                    <a href="/View/product-list.php?category_id=<?php echo $category->id; ?>" class="btn">Tìm Hiểu Thêm</a>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
